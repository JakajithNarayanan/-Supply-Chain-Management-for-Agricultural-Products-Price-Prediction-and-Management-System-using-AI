...
def get_price_prediction():
    ...
    predicted_price = predict_price(vegetable, city)  # Call the model
    ...
    return jsonify({'predicted_price': predicted_price, 'days_to_change': days_to_change})
